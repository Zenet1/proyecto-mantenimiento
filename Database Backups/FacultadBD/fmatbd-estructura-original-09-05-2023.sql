...
-- Tiempo de generación: 09-05-2023 a las 20:08:17
...
CREATE TABLE `administradores` (
  ...
  `ApellidoPaternoAdmin` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  `ApellidoMaternoAdmin` varchar(45) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `capturadores` (
  ...
  `ApellidoPaternoCapt` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  `ApellidoMaternoCapt` varchar(45) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
